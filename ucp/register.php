...
$sql ="INSERT INTO users(name,email, password, gender, mobile, designation, image, status, income) VALUES(:name, :email, :password, :gender, :mobileno, :designation, :image, :income, 1)";
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <input type="text" name="email" class="form-control" required>
														...
														<label class="col-sm-1 control-label">PAN number<span style="color:red">*</span></label>
														<div class="col-sm-5">
