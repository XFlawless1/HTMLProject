	<nav class="ts-sidebar">
			...
			<li><a href="taxcalc.php"><i class="fa fa-dollar"></i> &nbsp;Tax Calculator</a>
			</li>
			</ul>
			<p class="text-center" style="color:#ffffff; margin-top: 100px;">© Ajay(Creator for UCP) ©Shrey Ratna (Editor)</p>
		</nav>
