...
<label class="col-sm-2 control-label">PAN<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="panno" class="form-control" required value="<?php echo htmlentities($result->panno);?>">
</div>
</div>
