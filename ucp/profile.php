...
if(isset($_POST['submit']))
  {
	...
	$query-> bindParam(':income', $salary, PDO::PARAM_STR);
	$query-> bindParam(':panno', $pan, PDO::PARAM_STR);
...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">PAN(PERMANENT ACCOUNT NUMBER)<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="panno" class="form-control" readonly required value="<?php echo htmlentities($result->panno);?>">
	</div>

	<label class="col-sm-2 control-label">Salary<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="salary" class="form-control" readonly required value="$<?php echo htmlentities($result->income);?>">
	</div>
</div>
